...
unique_epochs, n_par, m_labels, epoch = grb_core.grb_characteristics(grb_df=df_band,
                                                                     model_name=m_name,
...
grb_core.two_scatter(start, end,
                     x, y,
                     x_err, y_err, plot_axis=ax, x_time=True, remove_extra=True)
